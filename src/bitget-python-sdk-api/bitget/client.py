...
class Client(object):
    ...
    def __init__(self, api_key, api_secret_key, passphrase, use_server_time=False, first=False, demo_trading=False):
        ...
        self.first = first
        self.demo_trading = demo_trading  # 模拟盘模式
    ...
    def _request(self, method, request_path, params, cursor=False):
        ...
        header = utils.get_header(self.API_KEY, sign, timestamp, self.PASSPHRASE, self.demo_trading)
