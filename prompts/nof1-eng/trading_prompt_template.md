...
Below we provide various state data, price data, and prediction signals for you to discover alpha. Following this data is your current account information, value, performance, positions, etc.
...
## Current Market State of All Coins
...
**Intraday Sequence (by minute, Oldest → Newest):**
...
1. **Fee Awareness**: Expected profit must cover fee costs (0.07%) by at least 3-5 times.
2. **Basic Position Logic**:
