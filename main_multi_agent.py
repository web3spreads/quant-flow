#!/usr/bin/env python3
"""
Quant Flow - 多 Agent 架构版本
使用独立 Agent 为每个交易对维护独立上下文，并使用汇总 Agent 和现货 Agent
"""
...
class MultiAgentQuantFlowBot:
    """多 Agent 架构的 Quant Flow 交易机器人"""
    ...
    def _print_startup_banner(self):
        ...
        ╔═══════════════════════════════════════════════════════════╗
        ║                                                           ║
        ║      🤖 Quant Flow Multi-Agent Trading Bot 🤖           ║
        ║                                                           ║
        ║      独立上下文 + 汇总分析 + 现货定投决策                  ║
        ║                                                           ║
        ╚═══════════════════════════════════════════════════════════╝
...
def main():
    ...
    try:
        # 创建并启动机器人
        bot = MultiAgentQuantFlowBot(config_path="config.yaml")
        bot.start()
